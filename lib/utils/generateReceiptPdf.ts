...
export function generateReceiptPdf(data: ReceiptData) {
  ...
  doc.setFontSize(7.5);
  doc.setTextColor(textGray[0], textGray[1], textGray[2]);
  doc.text('Thank you for choosing Winsor Maison. For order inquiries or support, visit winsor.com or email support@winsor.com', pageWidth / 2, footerY, { align: 'center' });

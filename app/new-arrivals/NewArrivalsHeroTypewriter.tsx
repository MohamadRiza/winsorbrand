...
interface NewArrivalsHeroTypewriterProps {
  title?: string;
  subtitle?: string;
}

export default function NewArrivalsHeroTypewriter({
  title = 'New Arrivals Collection',
  subtitle = 'Be the first to discover our newest horological additions. Featuring refined cases, scratch-resistant sapphire crystal glass, and sleek modern dials.',
}: NewArrivalsHeroTypewriterProps) {
  ...
  useEffect(() => {
    ...
    const runLoop = async () => {
      while (!isCancelled) {
        ...
        // 2. Type Title ("New Arrivals Collection")
    ...
    <>
      <style jsx>{`
        ...
        .new-arr-caret {
          ...
          border-radius: 1px;
          animation: new-arr-caret-pulse 0.85s cubic-bezier(0.4, 0, 0.2, 1) infinite;
        }
        .new-arr-caret-sub {
          width: 1.8px;
          height: 0.88em;
      ...
      <div style={{ position: 'relative', marginBottom: '14px' }}>
        ...
        <h1 className="new-arr-title-live" aria-hidden="true">
          <span>
            {typedTitle}
            {cursorPos === 'title' && <span className="new-arr-caret" />}
          </span>
        </h1>
      </div>
      ...
      <div style={{ position: 'relative', maxWidth: '480px', marginBottom: '22px' }}>
        ...
        <p className="new-arr-subtitle-live" aria-hidden="true">
          <span>
            {typedSubtitle}
            {cursorPos === 'sub' && <span className="new-arr-caret new-arr-caret-sub" />}
          </span>
        </p>
      </div>
    </>

...
import MensHeroTypewriter from './MensHeroTypewriter';
  ...
  return (
    <div style={{ backgroundColor: '#faf7f0', color: '#1a1209', minHeight: '100vh', fontFamily: "'Jost', sans-serif", paddingBottom: '20px' }}>
      <style>{`
        ...
        .mens-toolbar-pills::-webkit-scrollbar {
          display: none !important;
          width: 0 !important;
          height: 0 !important;
        }
        .mens-toolbar-dropdowns {
          display: flex;
          gap: 10px;
          align-items: center;
        }
        ...
        @media (max-width: 640px) {
          ...
          .mens-hero-card-bottom {
            bottom: 12px !important;
            left: 14px !important;
            right: 14px !important;
          }
          .mens-hero-card-title {
            font-size: 16px !important;
          }
          .mens-hero-card-badge {
      ...
      >
        ...
        <div className="mens-hero-grid">
          ...
          <div style={{ textAlign: 'left' }} className="mens-hero-text-block">
            ...
            <MensHeroTypewriter />
            <div className="mens-hero-pills-row" style={{ display: 'flex', gap: '14px', flexWrap: 'wrap', alignItems: 'center' }}>
              <div style={{ padding: '8px 18px', background: 'rgba(139,105,20,0.2)', border: '1px solid rgba(223,177,91,0.45)', borderRadius: '20px', fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', fontWeight: 600, color: '#dfb15b' }}>
                {loading ? 'CURATED TIMEPIECES AVAILABLE' : `${filteredProducts.length} MEN'S TIMEPIECES AVAILABLE`}
              </div>
            </div>
          </div>
          ...
          <div className="mens-hero-img-card">
            ...
            <div className="mens-hero-card-bottom" style={{ position: 'absolute', bottom: '20px', left: '20px', right: '20px', zIndex: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
              <div>
                ...
                <span className="mens-hero-card-title" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '20px', color: '#ffffff', fontWeight: 500 }}>Precision & Performance</span>
              </div>
              <span className="mens-hero-card-badge" style={{ fontSize: '10px', letterSpacing: '0.15em', color: 'rgba(255,255,255,0.7)', border: '1px solid rgba(255,255,255,0.2)', padding: '4px 10px', borderRadius: '4px' }}>DUBAI 2023</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── MAIN CONTENT ── */}
      {/* ── MAIN CONTENT ── */}
      <div id="mens-catalog" style={{ maxWidth: '1400px', margin: '0 auto', padding: '20px 24px 100px' }}>

        {/* ── FILTER TOOLBAR ── */}
        <div className="mens-toolbar-container">
          
          {/* Search Box */}
          <div className="mens-toolbar-search">
          ...
          {/* Section Pills */}
          <div className="mens-toolbar-pills no-scrollbar">
          ...
          <div className="mens-toolbar-dropdowns">
            <select
              value={selectedGift}
              onChange={e => setSelectedGift(e.target.value)}
              aria-label="Filter by season and occasion"
              className="mens-toolbar-select"
            >

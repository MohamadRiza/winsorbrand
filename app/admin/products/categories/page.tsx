              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  {formData.label.trim() && (
                    <button
                      type="button"
                      onClick={() => checkSpelling('label', formData.label)}
                      disabled={checkingSpelling['label']}
                    ...
                    >
                      {checkingSpelling['label'] ? 'Checking...' : (
          ...
          <div className="bg-white rounded-xl border border-[#1a1209]/10 overflow-hidden shadow-sm">
            ...
            {filteredCategories.length === 0 && (
              <div className="text-center py-16">
                <div className="w-14 h-14 mx-auto mb-3 rounded-2xl bg-[#8B6914]/10 text-[#8B6914] flex items-center justify-center border border-[#8B6914]/20 shadow-sm">
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <rect x="3" y="8" width="18" height="4" rx="1" strokeWidth={1.8} />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 8v13m-7 0h14a2 2 0 002-2V12H3v7a2 2 0 002 2zM7.5 8a2.5 2.5 0 010-5A4.8 4.8 0 0112 8a4.8 4.8 0 014.5-5 2.5 2.5 0 010 5" />
                  </svg>
                </div>
